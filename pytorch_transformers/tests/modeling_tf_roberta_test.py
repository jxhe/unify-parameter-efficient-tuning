...
class TFRobertaModelTest(TFCommonTestCases.TFCommonModelTester):
    ...
    all_model_classes = (TFRobertaModel,) if is_tf_available() else ()
    ...
    class TFRobertaModelTester(object):
        ...
        def create_and_check_roberta_model(self, config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels):
