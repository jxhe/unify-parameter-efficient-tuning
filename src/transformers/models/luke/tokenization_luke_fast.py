...
class LukeTokenizerFast(BertTokenizerFast):
    r"""
    Construct a "fast" LUKE tokenizer (backed by HuggingFace's `tokenizers` library).

    :class:`~transformers.LukeTokenizerFast` is identical to :class:`~transformers.BertTokenizerFast` and runs
    ...
    slow_tokenizer_class = LukeTokenizer
